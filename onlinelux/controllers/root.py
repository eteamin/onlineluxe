...
from onlinelux.model import DBSession
...
class RootController(BaseController):
    """
    The root controller for the onlinelux application.
    ...
    @expose('onlinelux.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('onlinelux.templates.environ')
    def environ(self):
        """This method showcases TG's access to the wsgi environment."""
        return dict(page='environ', environment=request.environ)

    @expose('onlinelux.templates.data')
    @expose('json')
    def data(self, **kw):
        """
